...
export class RadixSorter {
    ...
    radixSortBGLayout: GPUBindGroupLayout;
    mergeBGLayout: GPUBindGroupLayout;
    numWorkGroupsBGLayout: GPUBindGroupLayout;
    reverseBGLayout: GPUBindGroupLayout;
    pushConstantsBGLayout: GPUBindGroupLayout;
    ...
    constructor(device : GPUDevice) {
        ...
        this.reversePipeline = this.device.createComputePipeline({
            ...
            compute: {
                module: this.device.createShaderModule({code: reverse_buffer}),
                entryPoint: "main",
            },
        });
    }
...
var SortChunkSize = 256;

var nextPow2 = function(x : number) {
    var a = x - 1;
    a |= a >> 1;
    a |= a >> 2;
    a |= a >> 4;
...
RadixSorter.prototype.getAlignedSize = function(size : number) {
